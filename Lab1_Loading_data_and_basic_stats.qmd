...
tmax_median_griffin <- median(griffin_daymet$tmax..deg.c)
tmin_median_griffin <- median(griffin_daymet$tmin..deg.c)

daymet_data_griffin_yearlytemp <- griffin_daymet %>%
  summarise(mean_tmax = mean(tmax..deg.c)) %>%
  mutate(year = str_remove(year,"Y"))
#kable(grouped_daymet_data_region)
